object Dependencies {
    ...
    object Kotlin {
        ...
        object Test {
            ...
            const val ktorServer = "io.ktor:ktor-server-test-host:${Versions.ktor}"

            object Junit5 {
                private const val junit5 = "org.junit.jupiter:junit-jupiter-"
                const val api = "${junit5}api:${Versions.testJunit5}"
                const val engine = "${junit5}engine:${Versions.testJunit5}"
            }
        }
    }
    ...
    object Kodein {
        ...
        object Ktor {
            ...
            const val jvm = "$kprefix-jvm:$version"
        }
    }
